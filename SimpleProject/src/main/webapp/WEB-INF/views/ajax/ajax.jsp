...
<body>
	...
	<pre>
		...
		* 핵심!! => 비동기통신 => 부분갱신 => 사용자 경험 향상 => 트래픽감소 
		
		-------------------------------------------------------
		
		전송 데이터 형식 => 과거에는 XML 사용 => 현재 JSON 자바스크랩트 객체 모양
	...
	<h3>1. 버튼 클릭해서 GET방식으로 요청보내서 데이터 받아서 화면에 출력!</h3>
	...
	<div class="form-group">
		...
		<div class="form-control">
			...
			id="ajax-btn" onclick="test1();">AJAX로 보내기</button>
		</div>
	</div>
	...
	<button class="btn btn-lg btn-primary" onclick="btn1();">버튼1</button> <br>
	<button class="btn btn-lg btn-secondaty" onclick="btn2();">버튼2</button>
	<script>
		function btn1(){
			$.ajax({
				url : 'revol/c',
