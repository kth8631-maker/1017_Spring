...
public class ApiService {
	...
	public String requestBeef() {
		...
		final String API_KEY = "1a04f651c5ccd49ccde106d08a2f340940deae80b34058bcf87c225a8e2ef402";
	...
	public String requestBlog(String query) {
		String clientId = "svrJyfsIwBl0HW_vUdN9"; //애플리케이션 클라이언트 아이디
	    String clientSecret = "POLvWgga2K"; //애플리케이션 클라이언트 시크릿
	    ...
	    String apiURL = "https://openapi.naver.com/v1/search/shop?query=" + text +"&start=2&sort=date";
    ...
    public String requestBusan(int pageNo) {
    	...
    	final String SERVICE_KEY = "?serviceKey=8baf40ddaaaf186a5193fb326aab5008949fe0530a384ecb506e1a89d54c50ef";
